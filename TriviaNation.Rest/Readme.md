...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *TriviaNation.Rest*):

Restore dependencies
```
    cd "TriviaNation.Rest"
    dotnet restore
```

Execute unit tests
```
    cd "TriviaNation.Rest/test/TriviaNation.Rest.Tests"
    dotnet test
```

Deploy application
```
    cd "TriviaNation.Rest/src/TriviaNation.Rest"
