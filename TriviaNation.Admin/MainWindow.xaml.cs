...
namespace TriviaNation
{
	...
	public partial class MainWindow : Window
	{
		...
		public MainWindow()
		{
			...
			_ViewModel.LoggedOut += _ViewModel_LoggedOut;
		}

		private void _ViewModel_LoggedOut(object sender, EventArgs e)
		{
			ShowLoginWindow();
		}
		...
		private void LoginView_LoginComplete(object sender, object e)
		{
			...
			_ViewModel.LoggedInUserName = Application.Current.Properties["LoggedInUserName"] as string;
		}
